...
const useStyles = makeStyles((theme) => ({
    ...
    buttonRoot: {
        ...
        '&:before': {
            content: '" "',
            background: 'linear-gradient(45deg, #b1d6ff, #4994e8,#b365ef, #c706c5, #a503a1,#ec05e6,#f582f2, #9bc6f7, #b1d6ff)',
            position: "absolute",
            top: "-2px",
            left: "-2px",
            backgroundSize: "400%",
                ...
                <div className={classes.paper}>
                    ...
                    <form className={classes.form}>
                        <Grid container spacing={2}
                            ...
                            <Grid item>
                                <FormControlLabel
                                    control={<Checkbox classes={{root: classes.checkBoxStyle}}
